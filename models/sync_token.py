...
def b64encode_json(json_data):
    return base64.b64encode(json.dumps(json_data).encode()).decode("utf-8")
...
class SyncToken:
    ...
    def from_headers(headers):
        ...
        try:
            ...
            logger.error("Sync token contents do not follow the expected json schema.")
            return SyncToken()
        ...
        try:
            ...
            logger.error("SyncToken timestamps don't parse to a datetime.")
