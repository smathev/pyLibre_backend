        ...
        async with self.get_session() as session:
            try:
                ...
                if not book_author_links:
                    ...
                    return {'status': 'error', 'message': 'No such author associated with this book'}, 404
        ...
        async with self.get_session() as session:  # Ensure you are passing the session correctly
            try:
                ...
                result = await session.execute(
                    ...
                    .filter_by(book_id=author_update_schema.book_id, author_id=author_update_schema.author_id)
                )
                ...
                return {'status': 'error', 'message': 'Author already associated with this book'}, 400
